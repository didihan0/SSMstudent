    ...
    <script>
        $(function () {
            $("#ss").click(function () {
                ...
                location.href="${pageContext.request.contextPath}/product/sstextwoman.do?number="+number+"";
            })
        })
    </script>
</head>
                    ...
                    <div class="table-box">
                        ...
                        <div class="box-tools pull-right">
                            <div class="has-feedback">
                                ...
                                <button id="ss" class="btn btn-default" >搜索</button>
                            </div>
                        </div>
                        <!--工具栏/-->
                        <div class="pull-left">
                            <div class="form-group form-inline">
                                <div class="btn-group">
                                    <button type="button" class="btn btn-default" title="刷新" onclick="location.href='${pageContext.request.contextPath}/product/tzwoman.do?page=1&size=${page.pageSize}'">
                        ...
                        <table id="dataList"
                            ...
                            <tr>
                                ...
                                <th class="sorting_asc sorting_asc_disabled">宿舍</th>
                            ...
                            <c:forEach items="${pagewoman.list}" var="st">
