    ...
    <script>
        $(function () {
            $("#ss").click(function () {
                ...
                location.href="${pageContext.request.contextPath}/product/sstextman.do?number="+number+"";
            })
        })
    </script>
</head>
                    ...
                    <div class="table-box">
                        ...
                        <div class="pull-left">
                            <div class="form-group form-inline">
                                <div class="btn-group">
                                    <button type="button" class="btn btn-default" title="刷新" onclick="location.href='${pageContext.request.contextPath}/product/tzman.do?page=1&size=${page.pageSize}'">
                        ...
                        <table id="dataList"
                            ...
                            <tr>
                                ...
                                <th class="sorting_asc sorting_asc_disabled">宿舍号</th>
                            </tr>
                            </thead>
                            <tbody>


                            <c:forEach items="${pageman.list}" var="st">
