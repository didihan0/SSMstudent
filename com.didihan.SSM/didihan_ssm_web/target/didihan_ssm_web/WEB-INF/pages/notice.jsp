                ...
                <div class="box box-primary">
                    ...
                    <div class="box-body">
                        ...
                        <div class="table-box">
                            ...
                            <table id="dataList"
                                ...
                                <thead>
                                <tr>
                                    <th class="sorting_asc sorting_asc_disabled">通知</th>
                                    <th class="sorting_asc sorting_asc_disabled">通知时间</th>
                                </tr>
                                </thead>
                                <tbody>
                                ...
                                <c:forEach items="${notice.list}" var="notice">
                                    ...
                                    <tr>
                                        ...
                                        <td class="text-center">
                                            <button type="button" class="btn bg-olive btn-xs" onclick="location.href='${pageContext.request.contextPath}/product/deletenotice.do?number=${notice.number}&page=${page.pageNum-1}&size=${page.pageSize}'">删除</button>
                                            <button type="button" class="btn bg-olive btn-xs" onclick="location.href='${pageContext.request.contextPath}/product/findonenotice.do?number=${notice.number}'">详情/修改</button>
                                        </td>
                                    </tr>
                                </c:forEach>
                                </tbody>
                    ...
                    <div class="box-footer">
                        <div class="box-tools pull-left">
                            <ul class="pagination">
                                <li><a href="${pageContext.request.contextPath}/product/newnotice.do" aria-label="Previous">新增通知</a></li>
                            </ul>
                        </div>
                        <div class="box-tools pull-right">
                            <ul class="pagination">
                                <li><a href="${pageContext.request.contextPath}/product/gotonotice.do?page=1&size=${page.pageSize}" aria-label="Previous">首页</a></li>
                                <li><a href="${pageContext.request.contextPath}/product/gotonotice.do?page=${page.pageNum-1}&size=${page.pageSize}">上一页</a></li>
                                <li><a href="${pageContext.request.contextPath}/product/gotonotice.do?page=${page.pageNum+1}&size=${page.pageSize}">下一页</a></li>
                                <li><a href="${pageContext.request.contextPath}/product/gotonotice.do?page=${page.pages}&size=${page.pageSize}" aria-label="Next">尾页</a></li>
                            </ul>
                        </div>
