    ...
    <script>
        $(function () {
            $("#release").click(function () {
                ...
                location.href="${pageContext.request.contextPath}/product/releasenotice.do?title="+title+"&notice="+notice+"";
            })
        })
    </script>
</head>
                        ...
                        <div class="tab-content">
                            ...
                            <div class="tab-pane active" id="tab-form">
                                ...
                                <div class="panel panel-default">
                                    ...
                                    <button type="button" class="btn bg-maroon btn-flat margin" id="release">发布通知</button>
                                    ...
                                    <div id="dayslist" class="panel-body">
                                        ...
                                        <div class="box box-success">
                                            ...
                                            <div class="box-body">
                                                <input type="text" class="form-control" placeholder="通知标题" value="" id="title"><br>
