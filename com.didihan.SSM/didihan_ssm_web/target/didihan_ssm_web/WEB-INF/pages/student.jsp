...
<div class="wrapper">
    ...
    <header class="main-header">
        ...
        <a href="all-admin-index.html" class="logo">
            ...
            <span class="logo-lg"><b>学生数据</b>后台管理</span>
        </a>
    ...
    <aside class="main-sidebar">
        ...
        <div class="input-group">
            ...
            <ul class="sidebar-menu">
                ...
                <li class="treeview">
                    <a href="#">
                        <i class="fa fa-folder"></i> <span>个人信息页面</span>
                    ...
                    <ul class="treeview-menu">
                        ...
                        <li id="admin-datalist4">
                            <a href="${pageContext.request.contextPath}/product/tz.do">
                                <i class="fa fa-circle-o"></i> 学生个人信息页面
                            </a>
                        </li>
                    </ul>
                </li>
                        ...
                        <div class="box-body box-profile">
                            ...
                            <ul class="list-group list-group-unbordered">
                                <li class="list-group-item">
                                    <b>姓名</b> <a class="pull-right">${st.name}</a>
                                </li>
                                <li class="list-group-item">
                                    <b>学号</b> <a class="pull-right">${st.number}</a>
                                </li>
                                <li class="list-group-item">
                                    <b>家庭住址</b> <a class="pull-right">${st.place}</a>
                                </li>
                                <li class="list-group-item">
                                    <b>系别</b> <a class="pull-right">${st.system}</a>
                                </li>
                                <li class="list-group-item">
                                    <b>班级</b> <a class="pull-right">${st.classrom}</a>
                                </li>
                                <li class="list-group-item">
                                    <b>宿舍号</b> <a class="pull-right">${room}</a>
                                </li>
                                <li class="list-group-item">
                                    <b>出生日期</b> <a class="pull-right">${st.both}</a>
                                </li>
                                <li class="list-group-item">
                                    <b>缴费情况</b> <a class="pull-right">${st.pay}</a>
                                </li>
                                <a href="gotoschool.do" class="btn btn-primary btn-block"><b>学校官网</b></a>
                            </ul>
                ...
                <div class="col-md-9">
                    <div class="nav-tabs-custom">
                        <ul class="nav nav-tabs">
                            <li class="active"><a data-toggle="tab">学院通知信息</a></li>
                        ...
                        <div class="tab-content">
                            <div class="active tab-pane" id="activity">
                                ...
                                <c:forEach items="${notice.list}" var="notice">
                                    <div class="post">
                                        <div class="user-block">
                                            ...
                                            <span class="description">发布于${notice.date}</span>
                                        </div>
                                        <!-- /.user-block -->
                                        <p>
                                                ${notice.notice}
                                ...
                                <div class="box-footer">
                                    <div class="box-tools pull-right">
                                        <ul class="pagination">
                                            <li><a href="${pageContext.request.contextPath}/product/gotostudent.do?number=${st.number}&page=1&size=${notice.pageSize}" aria-label="Previous">首页</a></li>
                                            <li><a href="${pageContext.request.contextPath}/product/gotostudent.do?number=${st.number}&page=${notice.pageNum-1}&size=${notice.pageSize}">上一页</a></li>
                                            <li><a href="${pageContext.request.contextPath}/product/gotostudent.do?number=${st.number}&page=${notice.pageNum+1}&size=${notice.pageSize}">下一页</a></li>
                                            <li><a href="${pageContext.request.contextPath}/product/gotostudent.do?number=${st.number}&page=${notice.pages}&size=${notice.pageSize}" aria-label="Next">尾页</a></li>
                                        </ul>
                                    </div>
